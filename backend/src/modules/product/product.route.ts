...
productRouter.get('/',           validateQuery(productQuerySchema), productController.listProducts);
productRouter.get('/landing',    productController.getLandingPage);
productRouter.get('/smart',      validateQuery(productQuerySchema), productController.listSmart);
productRouter.get('/search',     productController.searchSmart);
productRouter.get('/admin-list', authMiddleware, requireRole(['ADMIN']), validateQuery(productQuerySchema), productController.listProductsAdmin);
