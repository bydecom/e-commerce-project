...
import { createFeedbackSchema, createActionPlanSchema, updateActionPlanSchema, adminFeedbackQuerySchema } from './feedback.schema';
...
feedbackRouter.get('/',            authMiddleware, requireRole(['ADMIN']), validateQuery(adminFeedbackQuerySchema), feedbackController.listAdminFeedbacks);
